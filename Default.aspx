<%@ Page Title="Vendor" Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SAP_Vendor._Default"  StylesheetTheme="Default" %>
 ...
 <tr id="panelNewAttachment" runat="server" visible="true">
    ...
    <AlternatingRowStyle BackColor="White" />
                                      ...
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtRemarks" ErrorMessage="Remarks is required." Text="" Display="None" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                 ...
                                                 <%--<tr>  
                                                     <td colspan="2">
                                                      <asp:RequiredFieldValidator ID="RequiredFieldValidatorTo" runat="server" ControlToValidate="ddlTo" ErrorMessage="Submit to is required." Text="" Display="None" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                          </td>
                                                  <td  colspan="1" style="height:40px;text-align:right">
                                                      Submit To :<span class="required">*</span></td>
                                                     <td style="height:40px;text-align:right">
                                                            <asp:DropDownList ID="ddlTo" runat="server" CssClass="cbo" Width="250px">                                                               
                                                            </asp:DropDownList>                                                          
                                                    </td>
                                                </tr>--%>
                                                 <tr>
                           ...
                           <asp:Button ID="btnClear" runat="server" CssClass="btn btn-default"
                            Text="Clear" 
                            OnClick="btnClear_Click" />
                          <asp:Button ID="btnDraft" runat="server" CssClass="btn btn-info"
                            Text="Draft" 
