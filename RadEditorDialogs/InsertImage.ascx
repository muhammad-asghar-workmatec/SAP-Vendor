						...
						<tbody>
							<tr>
								<td class="reAllPropertiesLight" style="padding-left:3px;">
									<button type="button" id="iplAllProperties" class="rfdFlatButton">
										[allproperties]
									</button>
								</td>
								<td>
									<button type="button" id="iplInsertBtn" class="rfdPrimaryButton rfdFlatButton">
										[ok]
									</button>
								</td>
								<td>
									<button type="button" id="iplCancelBtn" class="rfdFlatButton">
										[cancel]
									</button>
								</td>
							</tr>
