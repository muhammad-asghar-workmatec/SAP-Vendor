...
<table cellpadding="0" border="0" cellspacing="0" class="reDialog HelpDialog" style="width: 700px; display: block; margin: 4px;">
	...
	<tr>
		<td style="text-align: left;">
			<div class="helpTopics">
				<!-- help topics go here -->
				<table  class="helpTable bottomBorder">
					<tr>
	...
	<tr>
		<td class="reBottomcell">
			<table border="0"  class="reConfirmCancelButtonsTbl">
				<tr>
					<td>
						<button type="button" onclick="javascript: Telerik.Web.UI.Dialogs.CommonDialogScript.get_windowReference().close();" id="OkButton" class="rfdFlatButton">
