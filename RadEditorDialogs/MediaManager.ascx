...
<script type="text/javascript">
	...
	Telerik.Web.UI.Widgets.MediaPreviewer.prototype = {
		...
		_createText: function(textValue)
		{
			...
			textBox.className = "rfdTextInput";
			return textBox;
		},
				...
				switch (item[2])
				{
					case "radio":
						...
						for (var i = 0; i < values.length; i++)
						{
							...
							$find("dialogsDecorator").decorate(this._propertyValuePane);
						}
						break;
					case "select":
...
<div id="MediaPreviewer" class="mediaPreviewer">
	...
	<telerik:RadMultiPage ID="mediaMultiPage" runat="server" Height="300px" SelectedIndex="0">
		...
		<telerik:RadPageView ID="propertiesPage" runat="server">
			<%--<table border="0"  style="width: 267px; display: block; margin-top: 0; float: left;" class="reControlsLayout">
				<tr>
				...
				<div class="redSection redSectionTop">
					...
					<div class="redRow">
						<div class="redConstrainWrapper">
							<label class="redLabel" for="mediaWidth">
								<script type="text/javascript">document.write(localization["Width"]);</script>
							</label>
							<input type="text" id="mediaWidth" /> <span class="redDimensionPixels">px</span>

							<%--<button id="ConstrainButton" class="redConstrainButton">&nbsp;</button>--%>

							<label class="redLabel redSecondLabel" for="mediaHeight">
								<script type="text/javascript">document.write(localization["Height"]);</script>
							</label>
							<input type="text" id="mediaHeight" /> <span class="redDimensionPixels">px</span>
						</div>
					</div>

					<div class="redRow">
						<label class="redLabel" for="mediaAlign">
						<script type="text/javascript">
							document.write(localization["Align"]);
						</script>
						</label>
					...
					<div class="redRow">
						<label class="redLabel" for="mediaProperties">
						<script type="text/javascript">
							document.write(localization["Properties"]);
						</script>
						</label>
						<select id="mediaProperties">
					...
					<div class="redRow">
						...
						<div class="redMsgContainer redMsgContainerFBDialogs redInlineBlock">
							<div id="propertyValueDescription"></div>
							<div class="propertiesField" id="propertyValuePane" style="display: none;"></div>
						</div>
					</div>
