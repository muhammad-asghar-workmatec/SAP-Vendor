...
<div id="InsertLink" class="reInsertLinkWrapper" style="display: none;">
	<table border="0"  class="reControlsLayout">
		...
		<tbody>
			...
			<tr>
				<td colspan="2">
					<table border="0"  class="reConfirmCancelButtonsTblLight">
						...
						<tbody>
							<tr>
								<td class="reAllPropertiesLight">
									<button type="button" id="lmlAllProperties" class="rfdFlatButton">
									[allproperties]
									</button>
								</td>
								<td>
									<button type="button" id="lmlInsertBtn" class="rfdPrimaryButton rfdFlatButton">
									[ok]
									</button>
								</td>
								<td>
									<button type="button" id="lmlCancelBtn" class="rfdFlatButton">
									[cancel]
									</button>
								</td>
							</tr>
