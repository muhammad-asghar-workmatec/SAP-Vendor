    ...
    public partial class Finance : System.Web.UI.Page
    {
        ...
        protected void btSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                obj.SAP_Vendor_ID = txtVendorID.Text;
                obj.UpdateDate = DateTime.Now;
                obj.IssuedBy = hidUserID.Value;
                ...
                db.ClearParameters();
                //string ActivityName = Request.QueryString["ActivityName"].ToString();
                //AddFlow(hidRecordID.Value, ActivityName);

                if (optApprove.Checked)
                {
                    AppStatus = "1";
                    _Action = "Approve";
                    dalBPM.SetVarValue("Message", "Your vendor " + txtName1.Text + " request has been has been approved and vendor id is " + txtVendorID.Text);
                ...
                else if (optReject.Checked)
                {
                    ...
                    AppStatus = "2";
                    _Action = "Disapprove";
                    dalBPM.SetVarValue("Message", "Your vendor " + txtName1.Text + " request has been disapproved due to  " + txtRemarks.Text);
        ...
        protected void btEmail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obj = new SAP_VendorCreation(db.GetObject((object)obj, SAP_VendorCreation.P_Request_ID, hidRecordID.Value).Rows[0]);
                obj.Email_Sent = "1";
                obj.Email_Sent_Date = DateTime.Now;
                db.UpdateObject((object)obj, SAP_VendorCreation.P_Request_ID);
                db.ClearParameters();
                LoadForm();
        ...
        public void SendEmail(string Message)
        {
            ...
            if (FromEmail.Equals(""))
            {
                lblEmail.Text = "Email address not found, please contact system administrator.";
                return;
            }
            System.Net.Mail.MailMessage msg = new System.Net.Mail.MailMessage(FromEmail, To);
            try
            {
                msg.Subject = "PK00 - " + txtName1.Text;
                msg.IsBodyHtml = true;
