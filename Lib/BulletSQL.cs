...
namespace SAP_Vendor
{
    ...
    public partial class BulletSQL
    {
        ...
        public string AddObject_GetAutoID(object Class, string SkipIdentity)
        {
            string query = "";
            string queryInsert = @"";
            string queryValue = @" Values (";
            try
            {
                ...
                queryInsert = queryInsert.Remove(queryInsert.Length - 1) + ") ";
                queryValue = queryValue.Remove(queryValue.Length - 1) + ")";
                query = queryInsert + " OUTPUT INSERTED." + SkipIdentity + " " + queryValue;
                return ExecuteScalar(query, CommandType.Text).ToString();
        ...
        public int AddObject(object Class, List<string> SkipIdentitys)
        {
            string query = "";
            string queryInsert = @"";
            string queryValue = @" Values (";
        ...
        public int UpdateObject(object Class, List<string> WhereID)
        {
            string queryUpdate = @"";
            try
            {
                ...
                foreach (PropertyInfo property in ptyClass)
                {
                    ...
                    if (WhereID.Count > 0)
                    {
                        if (!IsExistListItem(WhereID, property.Name.ToString()))
                            queryUpdate += property.Name + "=@" + property.Name + ",";
                    }
                }
                queryUpdate = queryUpdate.Remove(queryUpdate.Length - 1);
        ...
        bool IsExistListItem(List<string> WhereID, string property)
        {
            var value = WhereID.Find(item => item == property);
            if (value == null)
                return false;
            else
                return true;
        ...
        public string GetNextID(BulletSQL dbParent, string FieldName, string TableName)
        {
            string _result = "";
            string query = "";
            try
            {
                query = @"select Max(" + FieldName + ") + 1 from " + TableName;
                _result = dbParent.ExecuteScalarDefault(query, "0").ToString();
                if (_result.Equals("0"))
                    _result = "1";
            }
            catch (Exception ex)
        ...
        public string GetNextID(string FieldName, string TableName)
        {
            ...
            {
                query = @"select Max(" + FieldName + ") + 1 from " + TableName;
                _result = ExecuteScalarDefault(query, "0").ToString();
                if (_result.Equals("0"))
                    _result = "1";
            }
            catch (Exception ex)
        ...
        public DataRow GetDataRow(object Class, string WhereID, string Value)
        {
            string query = "";
            DataTable dt = null;
            try
        ...
        public DataRow GetDataRow(object Class, List<ListItem> WhereID)
        {
            string query = "";
            DataTable dt = null;
            try
            {
                ClearParameters();
                Type typClass = Class.GetType();
                query = "Select * From " + typClass.Name + " Where ";
                for (int i = 0; i < WhereID.Count; i++)
                {
                    AddParameter(WhereID[i].Text.ToString(), WhereID[i].Value.ToString());
                    query += WhereID[i].Text.ToString() + "=@" + WhereID[i].Text.ToString() + " AND ";
                }
        ...
        public DataRow GetLockDataRow(object Class, List<ListItem> WhereID)
        {
            string query = "";
            DataTable dt = null;
            try
            {
                ClearParameters();
                Type typClass = Class.GetType();
                query = "Select * From " + typClass.Name + " WITH (UPDLOCK) Where ";
                for (int i = 0; i < WhereID.Count; i++)
                {
                    AddParameter(WhereID[i].Text.ToString(), WhereID[i].Value.ToString());
                    query += WhereID[i].Text.ToString() + "=@" + WhereID[i].Text.ToString() + " AND ";
        ...
        public DataRow GetLockDataRow(object Class, string WhereID, string Value)
        {
            string query = "";
            DataTable dt = null;
            try
            {
                ClearParameters();
                Type typClass = Class.GetType();
                query = "Select * From " + typClass.Name + " WITH (UPDLOCK) Where " + WhereID + "= @" + WhereID;
                AddParameter(WhereID, Value);
                dt = GetDataTable(query);
            }
            catch (Exception ex)
