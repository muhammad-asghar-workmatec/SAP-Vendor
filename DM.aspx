<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DM.aspx.cs" Inherits="SAP_Vendor.DM" %>
...
&nbsp;<asp:RadioButton ID="optReturn" runat="server" Font-Bold="True" GroupName="A" 
                                ...
                                <asp:HiddenField ID="hidRemarks" runat="server" /><asp:HiddenField ID="hidUserID" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td>
